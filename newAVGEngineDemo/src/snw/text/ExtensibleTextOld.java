...
public class ExtensibleTextOld
{
	...
	public ExtensibleTextOld(String rawText, int defaultColor, int defaultFont,
							 int lineWidth)
	{
	...
	private Font[] getFontList()
	{
		// TODO
		Font[] f = new Font[3];
		f[0] = new Font("宋体", Font.PLAIN, 20);
		f[1] = new Font("宋体", Font.BOLD, 20);
		f[2] = new Font("宋体", Font.PLAIN, 30);
		return (f);
	}
